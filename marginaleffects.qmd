...
bar_dat <- data.frame(
    Percentage = c(10, 20, 50, 30, 30, 50, 30, 10),
    x = rep(c("medication", "ablation"), each = 4), 
...
p3 <- plotthis::TrendPlot(bar_dat, x = "x", y = "Percentage", group_by = "NYHA", scale_y = TRUE, title = "NYHA and 1-year treatment")
