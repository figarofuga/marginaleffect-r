...
marginaleffects::predictions(
  ...
  tibble::as_tibble() |> 
  dplyr::select(rowid, rowidcf, swang1, age, crea1, estimate, conf.low, conf.high)
...
cat("\n 4. Risk ratio and 95% confidence interval \n")
...
![forest plot](image/afsymp_forestplot.png){width=90%}

![responder fig](image/afsymp_responder.png)

![ML fig](image/afsymp_responder_grf.png)
