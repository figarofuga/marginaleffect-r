...
marginaleffects::comparisons(
  ...
  tibble::as_tibble() |> 
  dplyr::select(swang1, cat_chf, contrast,estimate, conf.low, conf.high, death_01) |> 
  print()
...
- Datasetを倍にして機械学習で推定する方法をD learnerという
- T learner
- X learner?
...
rhc_split <- rsample::initial_validation_split(rhc_ml)

train_dt <- rsample::training(rhc_split)
validation_dt <- rsample::validation(rhc_split)
test_dt <- rsample::testing(rhc_split)
