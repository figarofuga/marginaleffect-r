...
full_fit <- glm(formula =  death_01 ~ swang1 + age + sex + race + edu + income + cat_chf + wtkilo1 + temp1 + meanbp1 + resp1 + hrt1 + pafi1 + paco21 + ph1 + wblc1 + hema1 + sod1 + pot1 + crea1 + bili1 + alb1 + cardiohx + chfhx + immunhx + transhx + amihx,
               family = binomial,
               data    = rhc_prep)
...
modelsummary::modelsummary(
  full_fit,
  exponentiate = TRUE,
  coef_rename = c("swang1RHC" = "RHC", "cat_chfOthers" = "Not CHF"),
  fmt = 2,
