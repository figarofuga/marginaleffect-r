...
# fit <- glm(death_yn ~ swang1 + age + sex + adld3p + meanbp1 + hrt1 + resp1 + crea1 , data = rhc_prep, family = binomial)

fit <- glm(status ~ rx + age + sex + obstruct + perfor + adhere + surg + nodes, data = colon, family = binomial)
